...
function addFoodsAll() {
  ...
  menu.forEach(element => {
    section.innerHTML += (" " + createObject(element))
  });
}
...
{
  section.innerHTML= ""
  const japanMenu=menu.filter(a=>a.category=="Japan")
  japanMenu.forEach(x=> {section.innerHTML+= (" " + createObject(x))})
}
...
menu.forEach(element=>console.log(element.img))
